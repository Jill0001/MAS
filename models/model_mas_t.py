...
class VATNN(nn.Module):
    def __init__(self,topic_matrix_shape):
        ...
        self.fc_a_1 = nn.Linear(2048, 4096)
        self.fc_a_2 = nn.Linear(4096, 2)
        ...
        self.vafinal_fc_1 = nn.Linear(2, 4)
        self.vafinal_fc_2 = nn.Linear(4, 2)
    ...
    def forward(self,v, a, t):
        ...
        # all_concat = torch.cat((v_out,t_out),dim=1)

        all_out = self.vafinal_fc_1(va_out)
        all_out = self.vafinal_fc_2(all_out)
