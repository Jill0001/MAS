...
class VATNN(nn.Module):
    def __init__(self,topic_matrix_shape):
        ...
        self.conv_v_1 = nn.Conv2d(1, 32, (3,3), padding=(1,1))
        self.conv_v_2 = nn.Conv2d(32, 64, (3,3), padding=(1,1))
        self.conv_v_3 = nn.Conv2d(64, 128, (3,3), padding=(1,1))

        self.maxpool_v_1 = nn.MaxPool2d((4, 4))
        self.maxpool_v_3 = nn.MaxPool2d((3,4))
    ...
    def forward(self, v, a, t):
        ...
        # v = torch.zeros((batchsize,1,56,1024))
        v = self.relu(self.conv_v_1(v))
        v = self.maxpool_v_1(v)
        v = self.relu(self.conv_v_2(v))
        v = self.maxpool_v_1(v)
        v = self.relu(self.conv_v_3(v))
        v = self.maxpool_v_3(v)
