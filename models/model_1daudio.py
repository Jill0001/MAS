...
class VATNN(nn.Module):
    def __init__(self,topic_matrix_shape):
        ...
        self.conv1d_a_1 = nn.Conv1d(13,32,18,padding=(9))
        self.conv1d_a_2 = nn.Conv1d(32,64,5,padding=(2))
        self.conv1d_a_3 = nn.Conv1d(64,128,5,padding=(2))
        self.conv1d_a_4 = nn.Conv1d(128,256,5,padding=(2))
        self.conv1d_a_5 = nn.Conv1d(256,512,5,padding=(2))
        self.maxpool_1d_5 = nn.MaxPool1d((5))
        self.maxpool_1d_3 = nn.MaxPool1d((3))
        self.maxpool_1d_2 = nn.MaxPool1d((2))
    ...
    def forward(self, v, a, t):
        ...
        a = self.relu(self.conv1d_a_1(a))
        a= self.maxpool_1d_5(a)
        a = self.relu(self.conv1d_a_2(a))
        a= self.maxpool_1d_3(a)
        a = self.relu(self.conv1d_a_3(a))
        a = self.maxpool_1d_5(a)
        a = self.relu(self.conv1d_a_4(a))
        a = self.maxpool_1d_5(a)
        a = self.relu(self.conv1d_a_5(a))
        # a = self.maxpool_1d_2(a)
