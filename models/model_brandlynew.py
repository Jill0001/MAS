...
class VATNN(nn.Module):
    def __init__(self,topic_matrix_shape):
        ...
        self.conv3d_v_1 = nn.Conv3d(1, 32, (3,2,6), padding=(1,0,3))
        self.conv3d_v_2 = nn.Conv3d(32, 64, (2, 1, 6), padding=(1,0,3))
        self.conv3d_v_3 = nn.Conv3d(64, 128, (2, 1, 3), padding=(1, 0, 1))
        self.conv3d_v_4 = nn.Conv3d(128, 256, (2, 1, 3), padding=(1, 0, 1))
        self.conv3d_v_5 = nn.Conv3d(256, 512, (2, 1, 3), padding=(1, 0, 1))

        self.maxpool_3d_1 = nn.MaxPool3d((2, 1, 3))
        # self.maxpool_3d_2 = nn.MaxPool3d((2, 1, 3))
        self.maxpool_3d_2 = nn.MaxPool3d((2, 1, 2))
        self.maxpool_3d_final = nn.MaxPool3d((3, 1, 6))
        ...
        self.fc_text_2 = nn.Linear(30, 8)

        self.all_fc_1 = nn.Linear(16,8)
        self.all_fc_2 = nn.Linear(8,1)
        self.sm =nn.Sigmoid()
        # self.gelu = nn.Gelu()
    ...
    def forward(self, v, a, t):
        ...
        t_out =(self.fc_text_1(t_distance))
        t_out =(self.fc_text_2(t_out))
